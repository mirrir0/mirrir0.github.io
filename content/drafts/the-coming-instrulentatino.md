...
hat networks like Google, Facebook, Twitter, Amazon, and the like have been able to gain power has been through a fundamental centralization of the encoded utilities of processing disparate data of an individual user's preferences, cares, and desires into a centralized system that enables people to be able to interact with a given configuration of what exactly the people want to do.

like, something that bothers me here, is that... I am writing this blog post on a platform that I built. i didn't build every single interaction by hand. in fact, i didn't care to do so. i don't think that it is important that I do so. In fact, I think that the most important thing about the fact that I have done so is that i have built an **inner-net**, and not an internet.

Through being able to build the actual utilities for myself, i have realized that I don't really care about the interfaces that other people might use. In the most part, I'd like an interface that I can access their information (their posts, their videos, their blogs, their etc) **THROUGH** my own interfaces.

I think the future is personal. And I think that has to do with the distribution of the systems that allow you to build personal software.
